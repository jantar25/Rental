  ...
  return (
        <div className="flex flex-col items-center">
            ...
            <form className="flex w-full sm:w-2/3 md:w-1/2 mt-2">
                <input type="email" className="flex-1 px-4 py-2 rounded-l w-full" placeholder='Email' />
                <button className=' bg-green-600 py-2 px-4 rounded-r text-sm font-[600]'>Get Started</button>
            </form>
        </div>
  )
}
